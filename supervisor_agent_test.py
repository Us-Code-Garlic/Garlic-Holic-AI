...
class SupervisorResponse(BaseModel):
    service_type: str = Field(..., description="서비스 타입 (dementia/medicine)")
...
# Router 정의
members = ["dementia_agent", "medicine_agent"]
...
- 두 서비스 모두 필요하거나 명확하지 않으면 → dementia_agent (의료 우선)
...
def create_supervisor_graph():
    ...
    # dementia_agent, medicine_agent는 END로 직접 이동
...
async def health_check():
    ...
    return {
        ...
        "available_services": ["dementia_check", "medicine_reminder"]
    }
...
if __name__ == "__main__":
    ...
    print("Supervisor Agent: http://localhost:8002")
    print()
